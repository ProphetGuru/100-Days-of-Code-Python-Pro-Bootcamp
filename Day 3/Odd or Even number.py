...
# 
# Example Input 43, this is an odd number.
# Example Input 94, this is an even number.
# 
# Hint
...
print("I`m able to tell which numbers are odd numbers and which numbers are even numbers.", end='\n')
if number % 2 == 0:
